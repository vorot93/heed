//! Crate `heed` is a high-level wrapper of [MDBX], high-level doesn't mean heavy (think about Rust).
//!
//! It provides you a way to store types in MDBX without any limit and with a minimal overhead as possible,
...
//!
//! MDBX directly maps files parts into main memory, combined
//! with the bytemuck library allows us to safely zero-copy parse and serialize Rust types into MDBX.
//!
//! [MDBX]: https://en.wikipedia.org/wiki/Lightning_Memory-Mapped_Database
//!
//! # Examples
//!
